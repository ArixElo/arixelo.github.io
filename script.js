...
let names = ["Xiaomi Mi 9T", "Samsung Galaxy J5 2015 NFC", "Xiaomi Redmi Note 4", "Huawei P8/P9 Lite 2017"];
let codenames = ["davinci", "j5nlte", "mido", "prague"];
...
let shippedsoft = ["Android 9, MIUI 10", "Android 5.1 Lollipop", "Android 6.0 Marshmallow, MIUI 8", "Android 7.0 Nougat, EMUI 5"];
let storage = ["64 GB / 128 GB", "8 GB", "32 GB / 64 GB", "16 GB / 32 GB"];
let battery = ["4000 mAh", "2600 mAh", "4100 mAh", "3000 mAh"];
let display = ["6.39 inches AMOLED", "5.00 inch AMOLED", "5.50 inches IPS", "5.20 inches IPS"];
