...
const names = ['Xiaomi Mi 9T', 'Samsung Galaxy J5 2015', 'Xiaomi Redmi Note 4', 'Huawei P8/P9 Lite 2017'];
const codenames = ['davinci', 'j5nlte', 'mido', 'prague/hi6250'];
const cpus = ['Qualcomm Snapdragon 730, SDM730', 'Qualcomm Snapdragon 410, MSM8916', 'Qualcomm Snapdragon 625, MSM8953', 'HiSilicon Kirin 655, Hi6250'];
const gpus = ['Adreno 618', 'Adreno 306', 'Adreno 506', 'Mali-T830MP2'];
const memory = ['6 GB', '1.5 GB', '2 GB / 3 GB / 4 GB', '3 GB / 4 GB'];
const shippedsoft = ['Android 9, MIUI 10', 'Android 5.1 Lollipop, TouchWiz', 'Android 6.0 Marshmallow, MIUI 8', 'Android 7.0 Nougat, EMUI 5'];
const storage = ['64 GB / 128 GB', '8 GB', '32 GB / 64 GB', '16 GB / 32 GB'];
const battery = ['4000 mAh', '2600 mAh', '4100 mAh', '3000 mAh'];
const display = ['6.39 inches AMOLED', '5.00 inches AMOLED', '5.50 inches IPS', '5.20 inches IPS'];
const images = ['src/img/davinci.png', 'src/img/j5nlte.png', 'src/img/mido.png', 'src/img/prague.png'];
